...
class Output_for_input_sequence_pattern(Pattern):
    ...
    def violated_by_partial_graph(self, partial_graph):
        violate = False

        actual_output = get_actual_output_for_input_sequence(self.input_sequence, partial_graph, partial_graph.red_states)
