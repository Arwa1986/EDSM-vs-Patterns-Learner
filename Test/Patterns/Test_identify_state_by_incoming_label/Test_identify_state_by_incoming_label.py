...
from Utilities.Pattern import identify_state_by_incoming_label_pattern
...
class MyTestCase(unittest.TestCase):
    ...
    def test_something(self):
        expected_result = [(self.state1, 'a/1')]

        actual_result = identify_state_by_incoming_label_pattern(self.G)
