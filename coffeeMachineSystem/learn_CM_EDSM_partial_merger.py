...
CM_pos_walks, evalutation_CM_neg_walks = generate_random_walks(CM_Graph, 10, 40, 3)
...
Training_CM_pos_walks = CM_pos_walks
...
coffeMachine_pta.build_labeled_pta(CM_Graph ,Training_CM_pos_walks)
# pta_networkx = dictionary_to_networkx2(coffeMachine_pta.G.graph)
# draw the PTA
# draw_multidigraph_with_labels(pta_networkx, 'PTA')
graph_to_dot(coffeMachine_pta.G, "pta.dot")
...
# edsm_networkx = dictionary_to_networkx2(coffeMachine_edsm.pta.G.graph)
# draw_multidigraph_with_labels(edsm_networkx, 'edsm')
graph_to_dot(coffeMachine_edsm.pta.G, "edsm.dot")
